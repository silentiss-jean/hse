(function () {
  ...
  /**
   * Récupère les capteurs HSE enrichis avec room_id, room_name, room_icon,
   * lovelace_title et type_id provenant de la customisation (meta_store).
   * @param {Object} hass
   * @returns {Promise<Array>} Sensors enrichis
   */
  async function fetch_sensors_enriched(hass) {
    ...
    // Normalise rooms (tableau ou objet)
    const rooms = {};
